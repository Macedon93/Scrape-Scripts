...
def greenhouse(driver):
    ...
    # add university
    try:
        driver.find_element_by_xpath("//select/option[contains(.,'Montclair State University')]").click()
    except NoSuchElementException:
        pass
    ...
    # add major
    try:
        driver.find_element_by_xpath("//select/option[contains(.,'Data Science')]").click()
    except NoSuchElementException:
        pass
